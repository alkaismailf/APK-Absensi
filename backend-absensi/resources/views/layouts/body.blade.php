...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand-link">
      ...
      <h4 class="brand-text font-weight">ADMIN PAGE</h4>
    </div>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <h5><a href="#" class="d-block"> Hello, <strong>{{ Auth::user()->name }}</strong></a></h5>
        </div>
      </div>
...
<script>
  $(function () {
    $("#example1").DataTable({
      ...
      "buttons": [
          {extend: 'pdf', title:'Laporan Kehadiran Karyawan'},
        ]
